...
скрипта не принимается, проверьте поле url на правильность. Для подсчёта количества строк разбейте текст 
...
with open('Посчитать кол-во строк в файле.txt') as a:
    for i in a:
        b=i.strip()
        print(requests.get(b).text.count('\n'))